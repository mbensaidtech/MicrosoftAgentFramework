...
namespace AIAgentWithToolKit.Tools;
...
/// 
/// TODO: Add [AITool] attribute to each PUBLIC method you want to expose to the AI agent.
/// The AITool attribute takes two parameters:
/// - name: The function name the AI will use to call this tool
/// - description: A description of what the tool does (helps the AI decide when to use it)
/// 
/// TODO: Add [Description] attribute to each parameter to help the AI understand what to pass.
/// 
/// Note: Only PUBLIC methods need the [AITool] attribute. Private methods are internal helpers.
/// </summary>
public class CompanyTools
{
    ...
    /// </summary>
    private string SearchEmployees(string searchTerm)
    {
    ...
    /// </summary>
    private string CheckRoomAvailability(string roomId, string date, string startTime, string endTime)
    {
    ...
    public string BookMeetingRoom(
        /* TODO: Add [Description("The room ID (e.g., ROOM-A)")] */ string roomId,
        /* TODO: Add [Description("The employee ID making the booking")] */ string employeeId,
        /* TODO: Add [Description("The date (format: yyyy-MM-dd)")] */ string date,
        /* TODO: Add [Description("Start time (format: HH:mm)")] */ string startTime,
        /* TODO: Add [Description("End time (format: HH:mm)")] */ string endTime,
        /* TODO: Add [Description("Meeting subject/title")] */ string subject)
    {
    ...
    /// </summary>
    private string GetVacationBalance(string employeeId)
    {
        if (_employees.TryGetValue(employeeId.ToUpper(), out var employee))
        {
