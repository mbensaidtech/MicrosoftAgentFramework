...
public class CompanyTools
{
    ...
    /// </summary>
    [AITool("get_employee_info", "Retrieves detailed information about an employee using their employee ID (e.g., EMP001, EMP002).")]
    ...
    /// </summary>
    [AITool("get_meeting_rooms", "Lists all available meeting rooms with their capacity and features.")]
    ...
    /// </summary>
    [AITool("book_meeting_room", "Books a meeting room for a specific date, time, and subject.")]
